...
<footer class="text-center text-lg-start bg-dark text-white">
    ...
    >
      ...
      <div class="me-5 d-none d-lg-block">
        <span>Hubungkan juga dengan medsos kami:</span>
      </div>
      <!-- Left -->
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">ketentuan layanan dan kondisi</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Privasi dan keamanan</a>
            </p>
            <p>
              <a href="client/room.php" class="text-reset">Kamar</a>
            </p>
            <p>
              <a href="client/event.php" class="text-reset">Rapat & Events</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="about.php" class="text-reset">Tentang</a>
            </p>
            <p>
              <a href="service.php" class="text-reset">Layanan</a>
            </p>
            <p>
              <a href="gallery.php" class="text-reset">Galeri</a>
            </p>
            <p>
              <a href="contact.php" class="text-reset">Kontak Kami</a>
            </p>
          </div>
          <!-- Grid column -->
