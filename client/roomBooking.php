...
<div class="container">
    <div class="row align-items-center my-5">
        ...
        <div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
            ...
            <h1>Booking Sebuah Kamar</h1>
            <p class="font-italic text-muted mb-0">Seluruh informasi sudah dimuat di akun Hotel Garuda ZZ anda.</p>
            ...
            <form action="client_functions.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    <div class="container mb-4">
                        <h2 class="text-center">Booking Kamar</h2>
                        <?php
                        if (isset($_GET["error"])) {
                    ...
                    <div class="form-group col-lg-6 mb-4">
                     ...
                     <div class="ml-2">
                         <label for="roomType">Type Kamar</label>
                     </div>
                    ...
                    <div class="form-group col-lg-6 mb-4">
                     ...
                     <div class="ml-2">
                         <label for="roomCost">Harga Kamar /per-Malam</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                    ...
                    <div class="form-group col-lg-12 mb-4">
                     ...
                     <div class="ml-2">
                         <label for="phoneNumber">Masukkan No Handphone</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                    ...
                    <div class="form-group col-lg-12 mb-4">
                     ...
                     <div class="ml-2">
                         <label for="no_of_guest">Jumlah orang</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                        ...
                        <select id="no_of_guest" name="no_of_guest" class="form-control custom-select bg-white border-left-0 border-md" required>
                            <option value="" selected="true" disabled="true">Pilih berapa orang yang akan menginap</option>
                    ...
                    <div class="form-group col-lg-6 mb-4">
                     ...
                     <div class="ml-2">
                         <label for="roomCost">Total Harga</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                            <i class="fa-solid fa-idr">Rp</i>
                            </span>
                        </div>
