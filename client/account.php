...
<br>
 ...
 <div class="container-fluid ml-5" id="contentArea">
     <div class="col-8 ml-5 pl-5">
         ...
         <h4 class="mb-4 text-center">Detail Akun</h4>
 ...
 <input type="hidden" id="user_Id" name="updateAccount" value="<?php echo $_SESSION['loggedUserId'];?>">
                <div class="row">
                    ...
                    <div class="ml-2">
                         <label for="updatefirstName">Nama Depan</label>
                     </div>
                    ...
                    <div class="input-group col-lg-6 mb-4">
                    <div class="ml-2">
                         <label for="updatelastName">Nama Belakang</label>
                     </div>
                     <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                    <div class="ml-2">
                         <label for="updatephoneNumber">Kontak</label>
                     </div>
                     <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                    <div class="ml-2">
                         <label for="updategender">Jenis Kelamin</label>
                     </div>
                    <div class="input-group ">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-white px-4 border-md border-right-0">
                ...
                <div class="form-group col-lg-6 mx-auto mb-0">
                        <button id="updateUser" type="submit" class="btn btn-primary btn-block py-2" name="updateUser" >
                            <span class="font-weight-bold">Simpan Perubahan</span>
                        </button>
                    </div>
        ...
        <h5 class="mb-4 mt-5 text-center">Ubah Password</h5>
