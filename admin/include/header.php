	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<nav id="sidebar" class="navbar-dark bg-dark">
			<div class="custom-menu">
	          ...
	          <span class="sr-only">Kotak Menu</span>
	        </button>
            </div>
	        ...
	        <ul class="list-unstyled components mb-5" id="nav">
				...
				<li class="nav-item">
					<a class="tab" href="gallery.php">Galeri</a>
				</li >
				<li class="nav-item">
	           ...
	           <li>
				...
				<li class="nav-item">
                    <a class="tab" href="roomType.php">type Kamar</a>
                </li>
				<li class="nav-item">
                    <a class="tab" href="room.php">Kamar</a>
                </li>
				<li class="nav-item">
                    <a class="tab" href="roomBooking.php">Kamar booking</a>
                </li>
	            </ul>
	          </li>
			  <li>
                ...
                <li class="nav-item">
                    <a class="tab" href="eventType.php">tipe Event </a>
                </li>
				<li class="nav-item">
                    <a class="tab" href="event.php">Event Mendaki</a>
                </li>
                <li class="nav-item">
			  ...
			  <li class="nav-item">
                    <a class="tab" href="roomPayment.php">Pembayaran Kamar</a>
                </li>
                <li class="nav-item">
                    <a class="tab" href="eventPayment.php">Pembayaran eventt</a>
                </li>
			  ...
			  <li class="nav-item">
              <a class="tab" href="contact.php">Kontak</a>
	          </li>

			  <li class="nav-item">
              <a class="tab" href="account.php">Akun</a>
	          </li> 
			  <li class="nav-item">
              <a class="tab" href="general_setting.php">Pengaturan</a>
	          </li>  
			  <li class="nav-item">
              <a class="tab" href="../destroy.php">Keluar</a>
	          </li>
	        </ul>
